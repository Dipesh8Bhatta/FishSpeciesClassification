...
# keras_path = os.path.join(get_parent_dir(0), "keras_yolo3")

utils_path = os.path.join(fp.keras_path, "Utils")
...
from keras_yolo3.Utils.Train_Utils import (
    get_classes,
    get_anchors,
    create_model,
    create_tiny_model,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--annotation_file",
        type=str,
        default=fp.YOLO_filename,
        help="Path to annotation file for Yolo. Default is " + fp.YOLO_filename,
    )
    parser.add_argument(
        "--classes_file",
        type=str,
        default=fp.YOLO_classname,
        help="Path to YOLO classnames. Default is " + fp.YOLO_classname,
    )
    ...
    parser.add_argument(
        "--weights_path",
        type=str,
        default=fp.weights_path,
        help="Path to pre-trained YOLO weights. Default is " + fp.weights_path,
    )
    parser.add_argument(
        "--val_split",
        type=float,
    ...
    num_val = int(float(len(lines) * val_split))
